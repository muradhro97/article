<nav class="sidebar">
    <div class="sidebar-header">
        <a href="#" class="sidebar-brand">
            {{__('dashboard.project_name')}}<span></span>
        </a>
    ...
    <div class="sidebar-body">
        <ul class="nav">
            <li class="nav-item nav-category">Newsfeed</li>
            <li class="nav-item {{ active_class(['apps/chat']) }}">
                <a href="{{ route('user.articles.index') }}" class="nav-link">
            ...
            @if(auth()->check() and auth()->user()->type == 'admin')
                ...
                <li class="nav-item {{ active_class(['users']) }}">
                    <a class="nav-link" data-toggle="collapse" href="#users" role="button" aria-expanded="{{ is_active_route(['users']) }}" aria-controls="users">
                        ...
                        <span class="link-title">{{__('dashboard.users')}} </span>
                        <i class="link-arrow" data-feather="chevron-down"></i>
                    </a>
                    <div class="collapse {{ show_class(['users']) }}" id="users">
                        <ul class="nav sub-menu">
                            <li class="nav-item">
                                <a href="{{ route('admin.users.create') }}" class="nav-link {{ active_class(['users/create']) }}">{{__('dashboard.add')}}</a>
                            </li>
                            <li class="nav-item">
                                <a href="{{ route('admin.users.index') }}" class="nav-link {{ active_class(['users']) }}">{{__('dashboard.list')}}</a>
                            </li>
                        </ul>
                    </div>
                </li>
                <li class="nav-item {{ active_class(['articles']) }}">
                    <a class="nav-link" data-toggle="collapse" href="#articles" role="button" aria-expanded="{{ is_active_route(['articles']) }}" aria-controls="articles">
                        <i class="link-icon" data-feather="book"></i>
                        <span class="link-title">Articles</span>
                        <i class="link-arrow" data-feather="chevron-down"></i>
                    </a>
                    <div class="collapse {{ show_class(['articles']) }}" id="articles">
                        <ul class="nav sub-menu">
                            <li class="nav-item">
                                <a href="{{ route('admin.articles.create') }}" class="nav-link {{ active_class(['articles/create']) }}">{{__('dashboard.add')}}</a>
                            </li>
                            <li class="nav-item">
                                <a href="{{ route('admin.articles.index') }}" class="nav-link {{ active_class(['articles']) }}">{{__('dashboard.list')}}</a>
                            </li>
                        </ul>
                    </div>
                </li>
            ...
            @if(auth()->check() and auth()->user()->type == 'owner')
                <li class="nav-item nav-category">Main</li>
                <li class="nav-item {{ active_class(['articles']) }}">
                    <a class="nav-link" data-toggle="collapse" href="#articles" role="button" aria-expanded="{{ is_active_route(['articles']) }}" aria-controls="articles">
                        <i class="link-icon" data-feather="book"></i>
                        <span class="link-title">My Researches </span>
                        <i class="link-arrow" data-feather="chevron-down"></i>
                    </a>
                    <div class="collapse {{ show_class(['articles']) }}" id="articles">
                        <ul class="nav sub-menu">
                            <li class="nav-item">
                                <a href="{{ route('articles.create') }}" class="nav-link {{ active_class(['articles/create']) }}">@lang('dashboard.add')</a>
                            </li>
                            <li class="nav-item">
                                <a href="{{ route('articles.index') }}" class="nav-link {{ active_class(['articles']) }}">{{__('dashboard.list')}}</a>
                            </li>
                        </ul>
                    </div>
                </li>
