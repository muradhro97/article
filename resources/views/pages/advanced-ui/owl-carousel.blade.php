        ...
        <div class="col-md-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    ...
                    <p class="card-description mb-0">Read the <a href="https://owlcarousel2.github.io/OwlCarousel2/"
                                                                 target="_blank"> Official Owl Carousel 2 Plugin
    ...
    <div class="row">
        ...
        <div class="col-md-6 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    <h6 class="card-title">Animation</h6>
                    <p class="card-description">Using <a href="https://daneden.github.io/animate.css/" target="_blank">animate.css</a>
                        library.</p>
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <p class="card-description">To add mouswheel scrolling just include the fantastic plugin <a
                            href="https://github.com/brandonaaron/jquery-mousewheel" target="_blank">jquery.mousewheel.js</a>.
                    </p>
