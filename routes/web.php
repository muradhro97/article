...
Route::group(
    ...
    Route::get('user/articles', 'User\ResearchController@index')->name('user.articles.index');
    Route::get('owner/show/{user}', 'Owner\ResearchController@showOwner')->name('owner.show');

    //login middleware group
    Route::group(['middleware' => 'auth'], function () {

        Route::get('articles/{article_file}/download', 'Owner\ResearchController@download_file')->name('articles.download_file');

        // owner routes
        Route::resource('articles', 'Owner\ResearchController');
        ...
        Route::group(['prefix' => 'user'], function () {
            Route::get('articles/{article}', 'User\ResearchController@show')->name('user.articles.show');
            // comment
            Route::post('articles/comment' , 'User\ResearchController@comment')->name('user.articles.comment');
        });
        ...
        Route::group(['prefix' => 'admin' , 'middleware' => 'admin' , 'as' => 'admin.'] , function () {
            ...
            // articles routes
            Route::resource('articles', 'Admin\ResearchController');
            // comments routes
            Route::delete('comments/{comment}', 'Admin\ResearchController@destroy_comment')->name('comments.destroy');
        });
